/**
 * @deprecated Legacy/demo SPA shell retained temporarily for migration reference.
 *
 * This file is not the canonical frontend runtime for Vellum. The intended
 * frontend architecture is the Next.js App Router under `frontend/app/*`.
 */
