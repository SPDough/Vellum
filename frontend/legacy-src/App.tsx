/**
 * @deprecated Legacy SPA application shell retained temporarily for migration reference.
 *
 * The canonical frontend runtime for Vellum is the Next.js App Router under
 * `frontend/app/*`. This file should not be treated as the primary app entry
 * for new work.
 *
