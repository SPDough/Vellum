...
class TradeValidationProtocol(Protocol):
    ...
    async def check_position_limits(
        self, account: str, symbol: str, quantity: int, context: ServiceContext
    ) -> OperationResult:
...
class SettlementProtocol(Protocol):
    ...
    async def confirm_settlement(
        self, trade_id: str, settlement_data: Dict[str, Any], context: ServiceContext
    ) -> OperationResult:
...
class SOPExecutionProtocol(Protocol):
    ...
    async def complete_execution(
        self, execution_id: str, context: ServiceContext
    ) -> OperationResult:
...
class RiskCalculationProtocol(Protocol):
    ...
    async def calculate_position_risk(
        self, position_data: Dict[str, Any], context: ServiceContext
    ) -> OperationResult:
...
class IAuditService(ABC):
    ...
    async def generate_audit_report(
        self, start_date: date, end_date: date, context: ServiceContext
    ) -> OperationResult:
...
class IDataService(ABC):
    ...
    async def store_data_record(
        self, data: Dict[str, Any], source: str, data_type: str, context: ServiceContext
    ) -> OperationResult:
        """Store a data record"""
        pass
    ...
    async def query_data(
        self, query_params: Dict[str, Any], context: ServiceContext
    ) -> OperationResult:
        """Query stored data"""
        pass
...
class IWorkflowService(ABC):
    ...
    async def start_workflow(
        self, workflow_type: str, input_data: Dict[str, Any], context: ServiceContext
    ) -> OperationResult:
    ...
    async def get_workflow_status(
        self, workflow_id: str, context: ServiceContext
    ) -> OperationResult:
...
class INotificationService(ABC):
    ...
    async def send_alert(
        self, alert_type: str, message: str, severity: str, context: ServiceContext
    ) -> OperationResult:
        """Send an alert"""
        pass
