...
class ConnectionManager:
    ...
    async def connect(self, websocket: WebSocket, source_id: str = None, user_id: str = None):
    ...
    async def send_data_update(self, source_id: str, data: Any, operation: str = "insert"):
    ...
    async def send_source_status_update(self, source_id: str, status: str, details: str = None):
    ...
    async def send_workflow_update(self, workflow_id: str, execution_id: str, status: str, output_data: Any = None):
    ...
    async def send_agent_result_update(self, agent_id: str, execution_id: str, result: Any):
...
class DataStreamService:
    ...
    async def handle_websocket_connection(self, websocket: WebSocket, source_id: str = None, user_id: str = None):
