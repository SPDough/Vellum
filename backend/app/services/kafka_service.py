...
class KafkaService:
    ...
    async def create_topic(self, topic_name: str, partitions: int = 3, replication_factor: int = 1):
    ...
    async def publish_mcp_event(self, server_id: str, event_type: str, data: Dict[str, Any]):
    ...
    async def publish_data_stream_event(self, stream_id: str, event_type: str, data: Dict[str, Any]):
    ...
    async def publish_position_update(self, account_id: str, position_data: Dict[str, Any]):
    ...
    def get_metrics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "handlers_count": sum(len(handlers) for handlers in self.message_handlers.values())
        }
