...
class Neo4jService:
    ...
    async def update_entity(self, entity_type: str, entity_id: str, properties: Dict[str, Any]) -> Dict[str, Any]:
        ...
        with tracer.start_as_current_span("neo4j_update_entity") as span:
            ...
            try:
                ...
                set_clauses = [f"e.{key} = $properties.{key}" for key in properties.keys()]
    ...
    async def get_relationships(self, entity_type: str, entity_id: str, direction: str = "both") -> List[Dict[str, Any]]:
