...
class TemporalService:
    ...
    async def register_workflow(self, workflow_id: str, workflow_definition: Dict[str, Any]) -> bool:
    ...
    async def _mcp_call_activity(self, config: Dict[str, Any], input_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _data_transform_activity(self, config: Dict[str, Any], input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "transform_applied": transform_code[:50] + "..." if len(transform_code) > 50 else transform_code,
                "timestamp": datetime.utcnow().isoformat()
            }
    ...
    async def _data_filter_activity(self, config: Dict[str, Any], input_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _send_notification_activity(self, config: Dict[str, Any], input_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _store_data_activity(self, config: Dict[str, Any], input_data: Dict[str, Any]) -> Dict[str, Any]:
        """Store data activity."""
        try:
    ...
    async def _wait_for_condition_activity(self, config: Dict[str, Any], input_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def schedule_workflow(self, workflow_id: str, schedule: str, input_data: Dict[str, Any] = None):
                ...
                for schedule_id, schedule_info in list(self.scheduled_workflows.items()):
                    ...
                    if schedule_info["next_run"] <= now:
                        ...
                        try:
                            ...
                            logger.info(f"Executed scheduled workflow {workflow_id}: {execution_id}")
    ...
    def get_workflow_execution(self, workflow_id: str, execution_id: str) -> Optional[Dict[str, Any]]:
