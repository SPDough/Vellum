...
from app.models.data import MCPServer, DataFlow, DataStream
    ...
    async def call_tool(self, tool_name: str, parameters: Dict[str, Any]) -> Dict[str, Any]:
        ...
        with tracer.start_as_current_span("mcp_tool_call") as span:
            ...
            try:
                ...
                span.set_attributes({
                    "mcp.success": True,
                    "mcp.response_size": len(str(result))
                })
...
class MCPService:
    ...
    async def list_servers(self, provider_type: Optional[str] = None, enabled_only: bool = False) -> List[Dict[str, Any]]:
    ...
    async def update_server(self, server_id: str, update_data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    ...
    async def test_server_connection(self, server_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "capabilities_discovered": [tool.get("name", "unknown") for tool in capabilities],
