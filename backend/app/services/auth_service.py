...
from app.models.user import User, UserAuditLog, UserRole, UserSession, UserStatus
...
class AuthService:
    ...
    def change_password(
        ...
        if not self.verify_password(current_password, user.hashed_password):
            self._log_audit(
                user_id, "password_change", "Invalid current password", "failure"
            )
            return False
        ...
        self._log_audit(
            user_id, "password_changed", "Password changed successfully", "success"
        )
        return True
