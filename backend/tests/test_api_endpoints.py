...
these tests currently run against the simplified demo backend via the shared
fixtures in `conftest.py`. As a result, `/api/auth/...` assertions here reflect
`app.main_simple` behavior, not the canonical full-backend `/api/v1/auth/...`
contract in `app.main`.
"""
...
@pytest.mark.demo_backend
class TestDemoAuthEndpoints:
    """Test authentication API endpoints on the simplified demo backend."""
...
@pytest.mark.integration
@pytest.mark.demo_backend
class TestDemoDataSandboxEndpoints:
    """Test Data Sandbox API endpoints on the simplified demo backend."""
...
@pytest.mark.integration
@pytest.mark.demo_backend
class TestDemoHealthEndpoints:
    """Test health and monitoring endpoints on the simplified demo backend."""
...
@pytest.mark.banking
@pytest.mark.demo_backend
class TestDemoBankingEndpoints:
    """Test banking-oriented endpoint expectations on the simplified demo backend."""
...
class TestDemoErrorHandling:
    """Test API error handling on the simplified demo backend."""
...
@pytest.mark.integration
@pytest.mark.demo_backend
class TestDemoSecurityHeaders:
    """Test security headers on the simplified demo backend."""
...
@pytest.mark.slow
@pytest.mark.demo_backend
class TestDemoPerformanceEndpoints:
    """Test performance-oriented expectations on the simplified demo backend."""
