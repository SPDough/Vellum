...
this module currently imports and tests `app.main_simple`, so it validates the
simplified demo/dev backend security behavior rather than the canonical full
backend in `app.main`.
"""
